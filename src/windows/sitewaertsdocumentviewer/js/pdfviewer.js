(function (window)
{
    ...
    function _addCloseable(handler)
    {
        _closeables.push(handler);
    }
        ...
        function ($rootScope, $q, log)
        {
            ...
            function _prepareClose(callback)
            {
                ...
                })).done(function ()
                {
                    ...
                    setTimeout(callback, 60 * 1000); // wait for pdfjs worker cleanup
               }, function (e)
                {
    ...
    window.prepareClose = function (callback)
    {
        _handler.forEach(function (handler)
        {
            handler.prepareClose(callback);
        });
    }
